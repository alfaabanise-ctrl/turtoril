...
const { isHidden, toggleHidden } = useNavVisibility();
...
<template>
  ...
  >
    <div class="flex min-h-[72px] items-center gap-4 px-4 sm:px-6 lg:px-8">
      ...
      <div class="min-w-0  items-center flex flex-1">
         <button
              type="button"
            ...
            >
              <Icon
                ...
                class="absolute text-xl h-5 w-5 transition-all duration-300"
                :class="
                  isHidden
        ...
        <div>
          <div class="flex items-center gap-2">
            ...
            <h1
              class="truncate text-lg font-bold tracking-tight text-gray-900 dark:text-white sm:text-xl"
            >
              {{ pageTitle }}
            </h1>
          </div>
      ...
      <div class="flex items-center gap-1.5 sm:gap-2">
        ...
        <div
          class="mx-1 hidden h-8 w-px bg-gray-200 sm:block dark:bg-gray-800"
        />
        ...
        <div class="relative">
          ...
          >
            ...
            <div class="hidden min-w-0 text-left lg:block">
              <p
                class="max-w-[120px] truncate text-sm font-semibold text-gray-900 dark:text-white"
              >
                {{ userName }}
              </p>
            ...
            <Icon
              ...
              class="hidden h-4 w-4 text-gray-400 transition-transform duration-150 lg:block"
          ...
          >
            ...
            >
              ...
              <div
                class="border-b border-gray-100 px-4 py-4 dark:border-gray-800"
              >
