...
const filteredItems = computed(() => {
  ...
  const keys =
    props.searchKeys ?? (props.columns.map((column) => column.key) as (keyof T)[]);
...
const getRowValue = (item: T, key: string) => {
  return item[key];
};
  ...
  <div class="w-full">
    ...
    >
      ...
      <div class="p-5 sm:p-6">
        ...
        <div
          v-if="showSummaryCards && allStats.length"
          ...
          >
            <div class="flex items-center gap-3">
              ...
              <div
                ...
                :class="colorMap[stat.color ?? 'gray']"
              >
                <Icon :name="stat.icon ?? 'heroicons:chart-bar'" class="h-5 w-5" />
              </div>
        ...
        <div class="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center">
          ...
          <div v-if="$slots.actions" class="flex items-center gap-2 sm:ml-auto">
            <slot name="actions" />
          </div>
        </div>
        ...
        >
          ...
          <div class="hidden md:block">
            <div class="h-12 bg-gray-50 dark:bg-gray-800" />
        ...
        >
          ...
          >
            <Icon
              :name="search ? 'heroicons:magnifying-glass' : 'heroicons:inbox'"
                  ...
                  >
                    ...
                    >
                      <slot
                        ...
                        :item="item"
                        :value="getRowValue(item, column.key)"
                      >
                        {{ getRowValue(item, column.key) }}
                      </slot>
                    </td>

                    <!-- Row actions -->

                    <td v-if="$slots.rowActions" class="px-5 py-4 text-right">
        ...
        <div v-if="$slots.footer" class="mt-4">
          <slot name="footer" :items="filteredItems" :total="items.length" />
        </div>
      </div>
    </div>
  </div>
