  ...
  <div class="space-y-6 pb-10">
    ...
    >
      <UiDataList
        ...
        :searchable="true"
        search-placeholder="Search student, email, reference..."
      >
        <!-- Filters -->
        <template #filters>
        ...
        <template #cell-admin="{ item }">
          <div class="flex items-center gap-2">
            <div
              class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-purple-50 dark:bg-purple-500/10"
            >
              <Icon name="i-heroicons-user" class="h-4 w-4 text-purple-500" />
            </div>
