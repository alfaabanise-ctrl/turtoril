...
const activities: Activity[] = [
  ...
  },
  {
    id: 3,
    actor: "System",
    action: "renewed subscription for",
    target: "Greenfield Academy",
    time: "1 hr ago",
    icon: "i-heroicons-credit-card",
  },
  {
    id: 4,
    actor: "Mr. Tunde",
    action: "removed a teacher account",
...
/> -->
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-8">
      ...
      <button
        class="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-indigo-600 text-white text-sm font-medium hover:bg-indigo-700 transition-colors shadow-sm"
      >
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
      ...
      >
        ...
        <p class="text-2xl font-semibold text-gray-900 dark:text-white leading-tight">
          {{ stat.value }}
        </p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
      <!-- Signups chart -->
      <div
        class="lg:col-span-2 rounded-2xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 p-6 shadow-sm"
      >
        <div class="flex items-center justify-between mb-6">
          ...
          <select
            class="text-sm rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-2 text-gray-600 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500/60"
          >
        ...
        <div class="flex items-end justify-between gap-3 h-48">
          ...
          >
            <div class="w-full flex items-end justify-center h-40 relative">
              <span
                class="absolute -top-6 text-xs font-medium text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity"
              >
                {{ m.value }}
              </span>
              <div
        ...
        <div class="flex flex-col gap-2">
          ...
          >
            ...
            <Icon
              ...
              class="w-4 h-4 ml-auto text-gray-300"
            />
          </NuxtLink>
        </div>
      </div>
    ...
    >
      <div class="flex items-center justify-between mb-5">
        ...
        <NuxtLink to="/activity" class="text-sm text-indigo-600 hover:underline"
          >View all</NuxtLink
        >
      </div>
      ...
      <div class="flex flex-col">
        ...
        >
          <div
            class="w-9 h-9 rounded-full bg-indigo-50 dark:bg-indigo-500/10 flex items-center justify-center shrink-0"
          >
            <Icon
              :name="activity.icon"
