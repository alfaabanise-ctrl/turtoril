...
const subscriptions = ref<Subscription[]>([
  ...
  },
  {
    ...
    amount: 25000,
    teacher: "Mr. Adewale",
    startedAt: "05 August 2026",
    expiresAt: "05 August 2027",
    status: "Active",
  },
  {
    id: 4,
...
const planStyles: Record<string, string> = {
  ...
  Yearly: "bg-indigo-50 text-indigo-600 dark:bg-indigo-500/10 dark:text-indigo-400",
};
  ...
  <div class="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
      <div>
        ...
        <p class="text-sm text-gray-400 mt-1">Manage student subscriptions and plans</p>
      </div>
